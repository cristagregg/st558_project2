...
1 represents 'Clear to some clouds', 2 represents 'Misty', and 3 represents 'Light snow or rain'.
...
comp <- data.frame(lm_MSE, lm_MSE1, rf_pred, boost_MSE)
knitr::kable(comp)
```

Boosting achieves the lowest test MSE of `r round(boost_MSE)`. 
